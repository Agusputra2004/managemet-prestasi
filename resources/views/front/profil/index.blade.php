...
<div class="float-center aligncenter">
    <img src="{{ asset('uploads/'. Auth::user()->foto) }}" alt="..." class="rounded-circle" style="border-style: dashed; padding: 5px; border-color: #0060a1; border-width: 5px;" width="250px" height="250px">
</div>
